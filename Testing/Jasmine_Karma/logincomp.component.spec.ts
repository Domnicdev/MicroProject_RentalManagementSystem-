...
describe('Login Component Test', () => {
  ...
  it('Login Component Test', () => {
    const fixture = TestBed.createComponent(LogincompComponent);
  ...
  it('Login Form Button GUI count', () => {
    const fixture = TestBed.createComponent(LogincompComponent);
    const formElement = fixture.debugElement.nativeElement.querySelector("#myform");
  ...
  it('Testing Form initial values(Login)', () => {
    const fixture = TestBed.createComponent(LogincompComponent);
    const login = fixture.componentInstance;
  ...
  it('Testing Form initial values(Login)', () => {
    const fixture = TestBed.createComponent(LogincompComponent);
    const login = fixture.componentInstance;
    login.myform.controls?.['userEmail'].setValue("domnicdev@gmail.com");
    login.myform.controls?.['userPassword'].setValue("11964");
