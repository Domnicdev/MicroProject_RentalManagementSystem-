...
public class InsertHouseOwner {
	...
	public void insertowner() {
		...
		driver.findElement(By.name("usertype1")).sendKeys("HouseOwner");
		driver.findElement(By.name("insertowner")).click();

	}

	public static void main(String[] args) {

		InsertHouseOwner obj = new InsertHouseOwner();
